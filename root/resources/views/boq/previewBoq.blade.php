...
<form class="priveiw-boq-form form-horizontal" method="POST"  enctype="multipart/form-data" action="{{url('boqs/uploadBoqPreview')}}">
	<?php $items = \App\Model\Item::get(['id','cat_id','code','name','unit_stock','unit_purch','unit_usage']); $building = json_encode($request['building_id']);?>
	{{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="building_id[]" id="boq-building" class="form-control boq-building my-select2" multiple>
                                                <option value=""></option>
...
<script type="text/javascript">
	...
	var buildings = JSON.parse(convertQuot("{{$building}}"));
	$('#boq-building').select2("val",buildings);
